...
class _$Season extends Season {
  ...
  _$Season._({this.id, this.title, this.episode}) : super._() {
    if (id == null) {
  ...
  @override
  int get hashCode {
    return $jf($jc($jc($jc(0, id.hashCode), title.hashCode), episode.hashCode));
  }
...
class SeasonBuilder implements Builder<Season, SeasonBuilder> {
  ...
  _$Season build() {
    ...
    try {
      _$result =
          _$v ?? new _$Season._(id: id, title: title, episode: episode.build());
    } catch (_) {
...
class _$Episode extends Episode {
  ...
  _$Episode._(
    ...
    if (subtitle == null) {
      throw new BuiltValueNullFieldError('Episode', 'subtitle');
    }
    if (url360 == null) {
